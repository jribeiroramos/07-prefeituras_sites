...
# Função para gerar a URL com base na regra proposta, com diferentes tentativas
def generate_url_variants(nome_municipio, uf):
    ...
    # Gerar variantes de URL
    nome_municipio_hifen = nome_municipio.replace(" ", "-").lower()  # Substituir espaços por "-"
    nome_municipio_sem_espaco = nome_municipio.replace(" ", "").lower()  # Remover espaços
